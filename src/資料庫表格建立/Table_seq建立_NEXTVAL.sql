...
INSERT INTO MEMBER 
VALUES('M001', '皮卡丘', 'Pikachu@gmail.com', 'Pikachu', '0915-523-698', '9593-9898-4545-2323', 1, 1, 1, 1000, 50, TO_DATE('1981-11-17','YYYY-MM-DD'), 1, 0);
INSERT INTO MEMBER 
VALUES('M002', '妙蛙種子', 'Bulbasaur@gmail.com', 'Bulbasaur', '0912-628-817', '9593-9897-1950-1812', 0, 1, 0, NULL, 50, TO_DATE('1988-07-15','YYYY-MM-DD'), 1, 0);
INSERT INTO MEMBER 
VALUES('M003', '小火龍', 'Charmander@gmail.com', 'Charmander', '0928-951-477', '9593-9897-9451-1556', 1, 1, 1, 500, NULL, TO_DATE('1985-06-06','YYYY-MM-DD'), 0, 0);
INSERT INTO MEMBER 
VALUES('M004', '傑尼龜', 'Squirtle@gmail.com', 'Squirtle', '0933-258-746', '9593-9897-1584-7845', 0, 0, 0, 1000, 55, TO_DATE('1995-02-09','YYYY-MM-DD'), 0, 0);
INSERT INTO MEMBER 
VALUES('M005', '伊布', 'Eevee@gmail.com', 'Eevee', '0935-336-681', '9593-9897-9585-5541', 0, 0, 0, 2000, 10, TO_DATE('1986-11-23','YYYY-MM-DD'), 1, 1);
INSERT INTO MEMBER 
VALUES('M006', '超夢', 'Mewtwo@gmail.com', 'Mewtwo', '0965-154-515', '9593-9897-5848-0290', 1, 1, 0, null, null, TO_DATE('1990-12-15','YYYY-MM-DD'), 0, 0);
--------------------
...
--DRIVER DATA
INSERT INTO DRIVER VALUES('M003','DR001','ABC-0001',EMPTY_BLOB(),EMPTY_BLOB(),
EMPTY_BLOB(),EMPTY_BLOB(),EMPTY_BLOB(),'1','1','2019-02-01','0','70.5','FORD','1','1','1','1');
INSERT INTO DRIVER VALUES('M004','DR002','ABC-0002',EMPTY_BLOB(),EMPTY_BLOB(),
EMPTY_BLOB(),EMPTY_BLOB(),EMPTY_BLOB(),'1','1','2019-02-01','0','70.5','FORD','1','1','1','1');
--
-- 建立費率RATE的表格
CREATE TABLE RATE(
...
RATE_PRICE  NUMBER(3,0)        NOT NULL,
BASIC_RATE  NUMBER(2,0)        NOT NULL
);
-- 建立費率RATE的假資料
INSERT INTO RATE VALUES(1, '一般時段(06~16)', 10, 60);
INSERT INTO RATE VALUES(2, '夜間時段(21~06)', 30, 60);
INSERT INTO RATE VALUES(3, '下班時段(17~20)', 20, 60);
--
...
INSERT INTO ACTIVITY VALUES('AC001','白色情人節',EMPTY_CLOB(),'2019-02-01','2019-03-14','FREE1',50,EMPTY_BLOB());
INSERT INTO ACTIVITY VALUES('AC002','清明返鄉優惠',EMPTY_CLOB(),'2019-03-29','2019-04-08','FREE2',100,EMPTY_BLOB());
INSERT INTO ACTIVITY VALUES('AC003','勞動節優惠',EMPTY_CLOB(),'2019-04-28','2019-05-04','FREE3',50,EMPTY_BLOB());
INSERT INTO ACTIVITY VALUES('AC004','母親節優惠',EMPTY_CLOB(),'2019-05-05','2019-05-19','FREE4',100,EMPTY_BLOB());
INSERT INTO ACTIVITY VALUES('AC005','端午返鄉優惠',EMPTY_CLOB(),'2019-06-01','2019-06-10','FREE5',100,EMPTY_BLOB());
...
VALUES ('MSG'||LPAD(to_char(MSG_ID_SEQ.NEXTVAL),3,'0'), 'M001', '豬年行大運，凡是生肖屬豬的一律打88折，到3月底喔~', '1');
...
INSERT INTO SINGLE_ORDER(
    ...
    END_LAT
,TOTAL_AMOUNT,
    ORDER_TYPE, LUNCH_TIME) 
VALUES (
    SEQ_SINGLE_ORDER.NEXTVAL, 'DR002', 'M001',
    5, '2019-02-14 05:30:00', '2019-02-14 05:50:00',
...
INSERT INTO SINGLE_ORDER(
    ...
    END_LAT
, TOTAL_AMOUNT,
    ORDER_TYPE, LUNCH_TIME) VALUES (
    SEQ_SINGLE_ORDER.NEXTVAL, 'DR001', 'M001',
    5, '2019-02-14 05:30:00', '2019-02-14 05:50:00',
...
CREATE TABLE GROUP_BAND(
 ...
 GROUP_LEADER NUMBER (5)   NOT NULL,
...
INSERT INTO GROUP_BAND VALUES('G'||LPAD(to_char(GROUP_BAND_SEQ.NEXTVAL),3,'0'),EMPTY_CLOB(),to_timestamp('2019/02/04','yyyy/mm/dd'),EMPTY_CLOB(),1,1,2,4,'五月天演唱會',5121,'桃園火車站','中壢火車站',1,EMPTY_BLOB(),'演唱會',5000,to_date('2019/02/15','yyyy/mm/dd'),5,'不錯ㄟ');
INSERT INTO GROUP_BAND VALUES('G'||LPAD(to_char(GROUP_BAND_SEQ.NEXTVAL),3,'0'),EMPTY_CLOB(),to_timestamp('2019/02/05','yyyy/mm/dd'),EMPTY_CLOB(),1,1,2,4,'道地ㄟ美食',5121,'台南火車站','高雄火車站',1,EMPTY_BLOB(),'美食',2500,to_date('2019/02/10','yyyy/mm/dd'),5,'好吃ㄟ');
--揪團成員
...
,'DR001','M001',0,1500,to_timestamp ('2019/02/5 15:05:20' , 'yyyy/mm/dd hh24:mi:ss'),to_date('2019/02/08 09:20:25' , 'yyyy/mm/dd hh24:mi:ss'),to_date('2019/2/08 09:50:25' , 'yyyy/mm/dd hh24:mi:ss') ,245.568,245.568,245.568,245.568,0,0,'無');
INSERT INTO GROUP_ORDER VALUES('GODR'||LPAD(to_char(GODR_ID_SEQ.NEXTVAL),3,'0')
,'DR002','M002',0,500,to_timestamp ('2019/02/8 20:07:25' , 'yyyy/mm/dd hh24:mi:ss'),to_date('2019/02/10 08:07:25' , 'yyyy/mm/dd hh24:mi:ss'),to_date('2019/2/10 10:20:25' , 'yyyy/mm/dd hh24:mi:ss') ,245.568,245.568,245.568,245.568,0,0,'無');
--檢舉揪團
...
INSERT INTO GROUP_REPORT (GREPORT_ID, MEM_ID, GROUP_ID, ADMIN_ID, STATE)
VALUES ('GR'||LPAD(to_char(GREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'G001' , 'A001', '1');
INSERT INTO GROUP_REPORT (GREPORT_ID, MEM_ID, GROUP_ID, ADMIN_ID, STATE)
VALUES ('GR'||LPAD(to_char(GREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'G001' , 'A001', '1');
INSERT INTO GROUP_REPORT (GREPORT_ID, MEM_ID, GROUP_ID, ADMIN_ID, STATE)
