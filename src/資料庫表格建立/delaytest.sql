...
VALUES ('SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0')
    , 'D002', 'M001',5,
    TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568
, 100, 0, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO SINGLE_ORDER(
    ...
    5, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '中央大學', '中壢火車站', 245.568, 245.568, 245.568, 245.568,100,
    0, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    STATE, START_TIME, END_TIME,
    START_LOC, END_LOC, START_LNG,
...
--新增10筆單人訂單假資料--
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    0, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    0, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    1, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    1, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    STATE, START_TIME, END_TIME,
    START_LOC, END_LOC, START_LNG,
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    2, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    2, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    STATE, START_TIME, END_TIME,
    START_LOC, END_LOC, START_LNG,
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    3, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    3, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    STATE, START_TIME, END_TIME,
    START_LOC, END_LOC, START_LNG,
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    4, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    4, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    STATE, START_TIME, END_TIME,
    START_LOC, END_LOC, START_LNG,
    ...
    5, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    5, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    STATE, START_TIME, END_TIME,
    START_LOC, END_LOC, START_LNG,
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    6, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    0, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    7, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    1, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    ...
    8, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    2, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
    INSERT INTO SINGLE_ORDER(
    ORDER_ID, DRIVER_ID, MEM_ID, 
    ...
    TOTAL_AMOUNT, ORDER_TYPE, LAUNCH_TIME) VALUES (
    'SODR'||LPAD(to_char(SEQ_SINGLE_ORDER.NEXTVAL),3,'0'), 'D001', 'M001',
    9, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'),
    '台北火車站', '台北101', 245.568, 245.568, 245.568, 245.568, 100,
    3, TO_TIMESTAMP ('2019-03-21 21:30:00', 'YYYY-MM-DD HH24:MI:SS'));
...
VALUES ('DR'||LPAD(to_char(DREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'A001', 'SODR001', '司機很無禮', '2019-03-21 07:30:00', '1');
INSERT INTO DRIVER_REPORT (DREPORT_ID, MEM_ID, ADMIN_ID, ORDER_ID, CONTENT, TIME, STATE)
VALUES ('DR'||LPAD(to_char(DREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'A002', 'SODR002', '司機態度不佳', '2019-03-21 08:30:00', '1');
INSERT INTO DRIVER_REPORT (DREPORT_ID, MEM_ID, ADMIN_ID, ORDER_ID, CONTENT, TIME, STATE)
VALUES ('DR'||LPAD(to_char(DREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'A001', 'SODR003', '司機態度不佳', '2019-03-21 09:30:00', '1');
...
,'G001','D001','M001',0,1500,to_timestamp ('2019/02/5 15:21:30' , 'yyyy/mm/dd hh24:mi:ss'),to_timestamp('2019/02/08 09:20:25' , 'yyyy/mm/dd hh24:mi:ss'),to_timestamp('2019/2/08 09:50:25' , 'yyyy/mm/dd hh24:mi:ss') ,245.568,245.568,245.568,245.568,5,0,'無','桃園火車站','中壢火車站');
INSERT INTO GROUP_ORDER VALUES('GODR'||LPAD(to_char(GODR_ID_SEQ.NEXTVAL),3,'0')
...
VALUES ('GR'||LPAD(to_char(GREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'G001' , 'A001', '揪團內容怪怪的', '2019-03-21 07:30:00','1');
INSERT INTO GROUP_REPORT (GREPORT_ID, MEM_ID, GROUP_ID, ADMIN_ID, CONTENT, TIME, STATE)
VALUES ('GR'||LPAD(to_char(GREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M001', 'G001' , 'A001', '揪團內容怪怪的', '2019-03-21 07:30:00','1');
INSERT INTO GROUP_REPORT (GREPORT_ID, MEM_ID, GROUP_ID, ADMIN_ID, CONTENT, TIME, STATE)
VALUES ('GR'||LPAD(to_char(GREPORT_ID_SEQ.NEXTVAL),3,'0'), 'M002', 'G001' , 'A001', '揪團內容怪怪的', '2019-03-21 07:30:00','1');
...
UPDATE SINGLE_ORDER SET STATE='3' WHERE ORDER_ID = 'SODR010'
