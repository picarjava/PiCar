...
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '妙蛙種子', 'M002@gmail.com', '123456', '0912-628-817', '9593-9897-1950-1812', 0, 1, 0, NULL, 50, TO_DATE('1988-07-15','YYYY-MM-DD'), 1, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '小火龍', '123', '123', '0928-951-477', '9593-9897-9451-1556', 1, 1, 1, 500, 500, TO_DATE('1985-06-06','YYYY-MM-DD'), 1, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '傑尼龜', '123', '123', '0933-258-746', '9593-9897-1584-7845', 0, 0, 0, 1000, 55, TO_DATE('1995-02-09','YYYY-MM-DD'), 1, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '伊布', 'M005@gmail.com', '123456', '0935-336-681', '9593-9897-9585-5541', 0, 0, 0, NULL, 10, TO_DATE('1986-11-23','YYYY-MM-DD'), 1, 1, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '比比鳥', 'M006@gmail.com', '123456', '0965-154-515', '9593-9897-6666-7777', 1, 1, 0, null, null, TO_DATE('1990-11-07','YYYY-MM-DD'), 0, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '可達鴨', 'M007@gmail.com', '123456', '0935-333-515', '9593-9897-3322-1145', 1, 1, 0, null, null, TO_DATE('1990-05-20','YYYY-MM-DD'), 0, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '卡蒂狗', 'M008@gmail.com', '123456', '0974-154-212', '9593-9897-1010-0302', 1, 1, 0, null, null, TO_DATE('1984-12-25','YYYY-MM-DD'), 0, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '鬼斯', 'M009@gmail.com', '123456', '0965-858-454', '9593-9897-2018-7885', 1, 1, 0, null, null, TO_DATE('1984-03-01','YYYY-MM-DD'), 0, 0, NULL);
INSERT INTO MEMBER 
VALUES('M'||LPAD(MEM_SEQ.NEXTVAL, 3, '0'), '超夢', 'M010@gmail.com', '123456', '0965-154-515', '9593-9897-5848-0290', 1, 1, 0, null, null, TO_DATE('1990-12-15','YYYY-MM-DD'), 0, 0, NULL);
--------------------
...
EMPTY_BLOB(),EMPTY_BLOB(),'1','1','2019-02-01','0','70.5','FORD','1','1','1','1');
INSERT INTO DRIVER VALUES('M004', 'D'||LPAD(to_char(DRIVER_ID_SEQ.NEXTVAL),3,'0'),'ABC-0002',EMPTY_BLOB(),EMPTY_BLOB(),
EMPTY_BLOB(),EMPTY_BLOB(),'1','0',null,'0','70.5','HONDA','1','1','1','1');
--
-- 建立費率RATE的表格
CREATE TABLE RATE(
...
INSERT INTO STORE_RECORD VALUES(to_char(sysdate,'yyyymmdd')||'-'||LPAD(to_char(STO_SEQ.NEXTVAL), 3, '0'), 'M001', SYSDATE, 50);
INSERT INTO STORE_RECORD VALUES(to_char(sysdate,'yyyymmdd')||'-'||LPAD(to_char(STO_SEQ.NEXTVAL), 3, '0'), 'M003', SYSDATE, 500);
INSERT INTO STORE_RECORD VALUES(to_char(sysdate,'yyyymmdd')||'-'||LPAD(to_char(STO_SEQ.NEXTVAL), 3, '0'), 'M001', SYSDATE, 450);
INSERT INTO STORE_RECORD VALUES(to_char(sysdate,'yyyymmdd')||'-'||LPAD(to_char(STO_SEQ.NEXTVAL), 3, '0'), 'M004', SYSDATE, 1000);
INSERT INTO STORE_RECORD VALUES(to_char(sysdate,'yyyymmdd')||'-'||LPAD(to_char(STO_SEQ.NEXTVAL), 3, '0'), 'M001', SYSDATE, 2000);
INSERT INTO STORE_RECORD VALUES(to_char(sysdate,'yyyymmdd')||'-'||LPAD(to_char(STO_SEQ.NEXTVAL), 3, '0'), 'M001', SYSDATE, 500);
--
