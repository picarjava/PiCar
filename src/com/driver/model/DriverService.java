...
public class DriverService {
	...
	public DriverService() {
		dao = new DriverJDBCDAO();
			}

	
	//比較JDBCDAO。利用多型 將VO變數傳入參數 用VO.set存
	public DriverVO addDriver(String memID,String driverID,String plateNum,byte[]  licence,byte[]  criminal,byte[]  trafficRecord ,byte[]  idNum, byte[]  photo ,Integer verified,Integer banned,Date deadline ,Integer onlineCar,Integer score ,String  carType ,Integer sharedCar ,Integer pet ,Integer smoke ,Integer babySeat ) {
...
//	}
	...
	public DriverVO updateDriver(String memID,String driverID,String plateNum,byte[]  licence,byte[]  criminal,byte[]  trafficRecord ,byte[]  idNum, byte[]  photo ,Integer verified,Integer banned,Date deadline ,Integer onlineCar,Integer score ,String  carType ,Integer sharedCar ,Integer pet ,Integer smoke ,Integer babySeat ) {
