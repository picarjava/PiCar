...
public class DriverReportDAO implements DriverReportDAO_interface{
	...
	private static final String GET_ALL_STMT =
		"SELECT DREPORT_ID, MEM_ID, ADMIN_ID, ORDER_ID,CONTENT, TIME, STATE FROM DRIVER_REPORT WHERE STATE='0' ORDER BY DREPORT_ID";
