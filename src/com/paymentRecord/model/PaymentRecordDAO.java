...
public class PaymentRecordDAO implements PaymentRecordDAO_interface {
	...
	private static final String INSERT_STMT = "INSERT INTO RATE (PAYMENT_ID, DRIVER_ID, PAY_AMOUNT, PAY_TIME) VALUES"
			+ "(?, ?, ?, ?)";
	...
	public void insert(PaymentRecordVO prVO) {
		...
		try {
			...
			pstmt.setString(1, prVO.getPaymentID());
			pstmt.setString(2, prVO.getDriverID());
			pstmt.setInt(3, prVO.getPayAmount());
			pstmt.setDate(4, prVO.getPayTime());
