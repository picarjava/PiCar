...
<!--                     <div class="form-group">
                     ...
                     <div class="form-group">
                      <p>活動海報</p>
                      <input type="file" class="form-control" name="activityPost" value="${driverVO.activityPost}"/>
                      <div class="card" style="width: 18rem;">
                          <img src="${driverVO.activityPost}" width="300" height="150" class="card-img-top" alt="..." >
                        </div>
                    </div> -->
