...
<body align="center">
	...
	<div style="margin-top: 50px;"></div>
	<c:forEach var="GroupBandVO" items="${list}" begin="<%=pageIndex%>"
		...
		<div class="services-half-width container">
			<div class="row">
				...
				<div class="services-half-width-text span9">
					...
					<br>
					<div class="floatSqu">
						<c:forEach var="x" begin="1" end="${GroupBandVO.upperLimit}"
							step="1">

							<c:if test="${x<=GroupBandVO.currenTnum}">
								<img
									src="<%=request.getServletContext().getContextPath()%>/front-end/groupBand/img/smogRed.png"
									class="floatSquare">
							</c:if>

							<c:if test="${x>GroupBandVO.currenTnum}">
								<img
									src="<%=request.getServletContext().getContextPath()%>/front-end/groupBand/img/smog.png"
									class="floatSquare">
							</c:if>
						</c:forEach>
					</div>
				...
				<div class="services-half-width-text span3">
					...
					<div style="margin-top: 10px">
						<FORM id="${GroupBandVO.groupID}" name="${GroupBandVO.groupID}"
							...
							<input type="hidden" name="action" value="GroupJoin">
